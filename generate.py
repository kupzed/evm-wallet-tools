...
def main():
    ...
    print("\nPilih Panjang Mnemonic Phrase:")
    print("1. 12 Kata (Standard - 128 bit)")
    print("2. 24 Kata (Extra Secure - 256 bit)")
    choice_word = input("Pilihan (1/2, default 1): ").strip()
    if choice_word == "2":
        strength = 256
        print("Menggunakan Mnemonic 24 Kata.\n")
    else:
        strength = 128
        print("Menggunakan Mnemonic 12 Kata.\n")
